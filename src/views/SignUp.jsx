...
const SignUp = (props) => {
    ...
    const toggle = tab => {
        ...
        if (tab == 1) {
            ...
            document.getElementById('1').firstChild.style.color = '#274F77'
            ...
            document.getElementById('2').firstChild.style.color = 'black'
        } else {
            ...
            document.getElementById('2').style.borderRadius = '3px'
            document.getElementById('2').firstChild.style.color = '#274F77'
            ...
            document.getElementById('1').style.borderRadius = '3px'
            document.getElementById('1').firstChild.style.color = 'black'
        }
    }
