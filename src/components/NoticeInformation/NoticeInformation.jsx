                    ...
                    content = {
                        <Fragment>
                            ...
                            <div className="margin-top">
                                ...
                                <b className="text-center center-block margin-top">IL DIRETTORE</b>
                            ...
                            {notice.articles.map((current) =>{
                                return (
                                    <Fragment>
                                        <u><b><h4 style={{"paddingLeft": "10px", "paddingRight": "10px"}}>{current.title}</h4></b></u>
                                        <i style={{"paddingLeft": "20px", "paddingRight": "20px"}}>{current.content}</i>
                                    </Fragment>
                                )
                            })}
                            <p className="margin-top">{notice.retification}</p>
                                <u><b><h4 className="margin-top" style={{"paddingLeft": "10px", "paddingRight": "10px"}}>TRATTAMENTO DEI DATI PERSONALI</h4></b></u>
                            <p style={{"paddingLeft": "20px", "paddingRight": "20px"}}>{notice.personal_data_treatment}</p>
                        </Fragment>
                    }
                />
            </div>
